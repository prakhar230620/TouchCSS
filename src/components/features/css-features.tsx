...
import { Zap, MousePointerClick, Film, Palette as PaletteIcon, Move, Variable as VariableIcon, Settings2, Lightbulb, Copy, CheckCircle } from "lucide-react";
